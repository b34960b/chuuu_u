...
// 조건 ? 조건이 참일 경우 : 조건이 거짓일경우 :
(card < 0) ? console.log('잔액부족 맨~') : console.log(card);
*/
...
var now_year_month_data = 20191014;
now_year_month_data *= 3;
console.log(now_year_month_data);
